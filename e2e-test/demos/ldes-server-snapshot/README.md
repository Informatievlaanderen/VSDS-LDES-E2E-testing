...
> **Note**: This test validates user story **As a Publisher, I want to serve a snapshot of a view where no snapshot exists for yet
   ...
   The collection `ldesfragment` now contains additional fragments which are part of the snapshot view, E.g. (for the medium-sized data set):
    ```json
    {
      ...
      "ids": [
        ...
        "/by-page?pageNumber=2",
        "/by-page?pageNumber=3",
        "/by-page?pageNumber=4",
        "/by-page?pageNumber=5",
        "/by-page?pageNumber=6",
        "/by-page?pageNumber=7",
        "/by-page?pageNumber=8",
        "/snapshot-2023-04-07T11:16:53.527491589",
        "/snapshot-2023-04-07T11:16:53.527491589?pageNumber=1",
        "/snapshot-2023-04-07T11:16:53.527491589?pageNumber=2",
        "/snapshot-2023-04-07T11:16:53.527491589?pageNumber=3"
      ]
    }
    ```
