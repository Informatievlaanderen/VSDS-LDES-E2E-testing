> TODO: update this document for GTFS multiview geo-spatial + timebased and timebased-only

Steps:
* copy & configure env.user
* docker compose --env-file env.user up
* logon and import workflow
* docker compose --env-file env.user up gtfs2ldes-js
* watch fragments being created
* verify views / fragments correctly created / linked
