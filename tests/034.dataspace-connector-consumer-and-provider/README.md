...
> **Note**: as of server v1.0 which uses dynamic configuration you need to execute the [seed script](./server/seed.sh)
...
```bash
curl http://localhost:8082/devices/paged?pageNumber=1
```
